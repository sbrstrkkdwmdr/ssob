...
const mathcmdopts: Discord.ApplicationCommandOptionChoiceData<string>[] = [
    ...
    {
        name: "Conversion to scientific notation (significant figures)",
        value: "sigfig",
    },
...
const timezoneopts: Discord.ApplicationCommandOptionChoiceData<string>[] = [
    {
        name: "Abidjan (Africa, Côte d’Ivoire/Ivory Coast)",
    ...
    {
        name: "Johannesburg (Africa, South Africa)",
    ...
    {
        name: "Sao Tome (Africa, São Tomé and Príncipe)",
    ...
    {
        name: "Danmarkshavn (America, Greenland)",
    ...
    {
        name: "Godthåb/Godthaab/Nuuk (America, Greenland)",
        value: "America/Godthab",
    },
    { name: "Goose Bay (America, Canada)", value: "America/Goose_Bay" },
    {
        name: "Grand Turk (America, Turks and Caicos Islands)",
    ...
    {
        name: "Metlakatla (America, USA or Canada idk which they're next to each other)",
    ...
    {
        name: "Center (North Dakota) (America, USA)",
        value: "America/North_Dakota/Center",
    },
    {
        name: "New Salem (America, USA)",
    ...
    {
        name: "Port of Spain (America, Trinidad and Tobago)",
        value: "America/Port_of_Spain",
    },
    {
        name: "Port-au-Prince (America, Haiti)",
    ...
    {
        name: "Santo Domingo (America, Domincan Republic)",
        value: "America/Santo_Domingo",
    },
    { name: "Sao Paulo (America, Brazil)", value: "America/Sao_Paulo" },
    {
        name: "Scoresbysund (America, Greenland)",
