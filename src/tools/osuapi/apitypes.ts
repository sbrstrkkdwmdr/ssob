...
export type Timestamp =
    `${number}-${number}-${number}T${number}:${number}:${number}${"+" | "-"}${number}:${number}`; //& Error
...
type NotificationEvent =
    | Notification_beatmapset_discussion_lock
    | Notification_beatmapset_discussion_post_new
    | Notification_beatmapset_discussion_unlock
    | Notification_beatmapset_disqualify
    | Notification_beatmapset_love
    | Notification_beatmapset_nominate
    | Notification_beatmapset_qualify
    | Notification_beatmapset_remove_from_loved
    | Notification_reset_nominations
    | Notification_channel_message
    | Notification_forum_topic_reply;
...
export { type Mod as ModAcronym } from "osumodcalculator/src/types";
